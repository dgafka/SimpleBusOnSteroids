...
class SimpleBusOnSteroidsExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('simple_bus_requeue_exchange_name', $config['requeue_exchange_name']);
        $container->setParameter('simple_bus_requeue_routing_key', $config['requeue_routing_key']);
    }
